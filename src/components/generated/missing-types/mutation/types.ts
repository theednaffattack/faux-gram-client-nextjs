...
export declare type RefetchQueriesProviderFn = (
  ...args: any[]
...
export declare type MutationFunc<
  TData = any,
...
export declare type DataValue<
  TData,
  TGraphQLVariables = OperationVariables
> = GraphqlQueryControls<TGraphQLVariables> & Partial<TData>;
...
export declare type ChildDataProps<
  TProps = {},
  TData = {},
  TGraphQLVariables = OperationVariables
> = TProps & DataProps<TData, TGraphQLVariables>;
export declare type ChildMutateProps<
  TProps = {},
  TData = {},
  TGraphQLVariables = OperationVariables
